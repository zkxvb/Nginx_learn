/*************************************************************************
	...
	> Author: zkxvb
	> Mail:  zkxvb@outlook.com 
	> Created Time: Tue 05 Jun 2018 03:35:49 AM EDT
 ************************************************************************/
...
static ngx_command_t ngx_http_hello_world_commands[] = {
	{
		...
		ngx_http_hello_world,			//The command hadler
...
//Structure for the HelloWorld module, the most importand thing
...
static ngx_int_t ngx_http_hello_world_handler(ngx_http_request_t *r){
	...
	r->headers_out.content_type.data = (u_char*)"text/palain";
